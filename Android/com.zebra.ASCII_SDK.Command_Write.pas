...
////////////////////////////////////////////////////////////////////////////////
unit com.zebra.ASCII_SDK.Command_Write;
...
type
  JCommand_Write = interface;

  JCommand_WriteClass = interface(JObjectClass)
    ['{494DA18D-01AD-440A-AE5E-A457387F17B0}']
    ...
    function getDoBlockWrite : boolean; cdecl;                                  // ()Z A: $1
    function getOffset : SmallInt; cdecl;                                       // ()S A: $1
    function getPassword : Int64; cdecl;                                        // ()J A: $1
    function init : JCommand_Write; cdecl;                                      // ()V A: $1
    ...
    procedure setData(value : TJavaArray<Byte>) ; cdecl;                        // ([B)V A: $1
    procedure setDoBlockWrite(value : boolean) ; cdecl;                         // (Z)V A: $1
  ...
  [JavaSignature('com/zebra/ASCII_SDK/Command_Write')]
  JCommand_Write = interface(JObject)
    ['{8D9425CF-2FBD-494F-BE85-A790529AB7A8}']
    function ToString : JString; cdecl;                                         // ()Ljava/lang/String; A: $1
    function _GetAccessConfig : JParam_AccessConfig; cdecl;                     //  A: $1
    function _GetReportConfig : JParam_ReportConfig; cdecl;                     //  A: $1
    function getBank : JENUM_MEMORY_BANK; cdecl;                                // ()Lcom/zebra/ASCII_SDK/ENUM_MEMORY_BANK; A: $1
  ...
  TJCommand_Write = class(TJavaGenericImport<JCommand_WriteClass, JCommand_Write>)
  end;

const
  TJCommand_WritecommandName = 'Write';
